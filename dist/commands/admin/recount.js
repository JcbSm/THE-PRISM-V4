...
let CountCountsCommand = class CountCountsCommand extends PrismCommand {
...
CountCountsCommand = __decorate([
    ApplyOptions({
        name: 'recount',
        description: 'Recount counts.',
    })
], CountCountsCommand);
export { CountCountsCommand };
//# sourceMappingURL=recount.js.map