...
export declare class ChannelCommand extends PrismSubcommand {
    ...
    chatInputRunCounting(interaction: PrismSubcommand.ChatInputCommandInteraction): Promise<import("discord.js").InteractionResponse<boolean> | import("discord.js").Message<true> | undefined>;
